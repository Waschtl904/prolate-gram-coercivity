...
frame-theoretic consequences. More precisely, the only genuinely
non-perturbative part of the present argument is the control of the PSWF
product family under spectral truncation; once that input is combined with
the XRY stability statement, the remaining frame-theoretic step is a
