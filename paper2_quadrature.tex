...
frame-theoretic consequences. At the same time, the main mathematical core
of the whole framework is not the final frame argument but the nonlinear
behaviour of the PSWF basis under pointwise multiplication: once that
product-side difficulty is controlled together with the XRY stability input,
the remaining frame-theoretic step is essentially a perturbative
consequence.
