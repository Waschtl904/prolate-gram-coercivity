...
construction of $Q_N$. With that distinction in place, it is reasonable to
expect the quadrature error to be governed primarily by the PSWF spectral
tail of the test function, up to a residual term that is exponentially
small in the regime $N\sim c$. This is also consistent with the role of
approximate spectral projectors and with the interpolation formulas
underlying the XRY construction. This does not prove
Conjecture~\ref{conj:xry_stability}, but it explains why a bound of the form
\[
