...
%%% Central notation (used throughout; must appear identically everywhere)
...
%%% Title note: alternative shorter form for consideration:
%%% "Universality and Structural Rigidity of Turning-Point Truncation Geometry"
...
%%% ============================================================
%%% ABSTRACT (arXiv version: tightened to four logical units)
%%% ============================================================
\begin{abstract}
...
%% DAG: font=small added for legibility at 100% zoom
\[
...
\begin{itemize}[nosep,leftmargin=1.5em]
  ...
  \item Decomposition stability (Lemma~\ref{lem:decomp_stability});
    balance fixed-point (Lemma~\ref{lem:balance_fixpoint});
    H1 exponent rigidity (Lemma~\ref{lem:H1_rigidity});
