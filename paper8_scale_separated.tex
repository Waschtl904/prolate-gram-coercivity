...
%  Status: working draft (revised v5: submission-ready)
% ============================================================
...
uniform gap lower bound, and is therefore independent
of any specific spectral asymptotics.
...
of the Dyadic Separation Principle as a purely
combinatorial mechanism, independent of any Airy or
global spectral structure, reducing the analytic burden
to a single local gap estimate.
This is not a renaming of hypothesis~H2: it is the
observation that H2 requires no spectral asymptotics
whatsoever — only monotonicity and a lower bound on
consecutive eigenvalue gaps.
