...
%%------------------------------------------------------------------
%% FIX 1: Asymptotic regime — explicit scaling limit
%%------------------------------------------------------------------
...
%%------------------------------------------------------------------
%% FIX 3: Oscillation–Gronwall link remark
%%------------------------------------------------------------------
...
controlled by Lemma~\ref{lem:prufer-oscillation-control}
(see Remark~\ref{rem:osc-gronwall-link} for the explicit link
between the oscillation estimate and the Gronwall framework).
...
since $\mathrm{supp}\,\rhocl_n = [-x_+(n),x_+(n)]
...
%%------------------------------------------------------------------
%% FIX 2: Theorem reformulated as semiclassical matching principle
%%------------------------------------------------------------------
...
$r_n^2 = 2\lambda_n\rhocl_n(1+O(1/n))$, so
$\tfrac{1}{2}\int_{I_\delta}fr_n^2
