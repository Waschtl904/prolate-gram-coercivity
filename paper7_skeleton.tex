...
(as $\alpha \not\equiv 0,\pi\pmod{2\pi}$),
the partial sums satisfy (standard bound for geometric sums)
\[
  \abs{B(s,t)}
  ...
  =: C_\alpha
\]
uniformly in $s \leq t$ and in $i$.
The constant $C_\alpha < \infty$ precisely because
$\alpha \not\equiv 0,\pi$.
