...
The following condition is the concrete realisation of the abstract
interface hypothesis \textup{AX5}: the rule $\{(p_j,w_j)\}$
satisfies the \emph{Discrete Spectral Transfer Property} on $V_{N,c}$
if there exist $C>0$, $p>1$ such that
\[
