...
$h\sum_j f_{mn}(p_j)=\int_{-T}^T f_{mn}\,dx+\sum_{k\ne 0}\hat{f}_{mn}(k/h)$.
...
this framework, not linear-algebraic orthogonality.
The Riemann-rule witness shows a rule may satisfy all of
\textup{AX1--AX4} and fail DSTP; no combination of analytic bounds
implies geometric compatibility.
