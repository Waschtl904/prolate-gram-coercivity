...
\begin{itemize}
  ...
  quadrature cancellation argument (Proposition~\ref{prop:T2}) where
  the smallness of $1-\lambda_n$ enters as a smallness parameter for
  the variation of $|\psin|^2$ over $[-T,T]$.
\end{itemize}
